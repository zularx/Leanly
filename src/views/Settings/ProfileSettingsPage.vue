<template>
    <div class="flex flex-col gap-10">
        <form @submit.prevent="submitProfileHandler" class="flex flex-col gap-4 border border-[#cbcfc3] dark:border-[#1e293b] p-6 rounded-2xl">
        ...
        <SettingsSection>
            ...
            <template #action>
                <NextStepBtn noMargin @click="connectGoogleHealthClicked">
                    Подключить
                </NextStepBtn>
            </template>
        </SettingsSection>
...
import { connectGoogleHealth } from '@/api/googleHealthApi';
...
async function connectGoogleHealthClicked() {
