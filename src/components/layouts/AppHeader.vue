<template>
    <header class="bg-[#f8fdef] dark:bg-[#0a1120] mt-3 h-20 rounded-2xl md:h-25 lg:h-30 transition-colors duration-100">
        <div class="flex h-full w-85 mx-auto items-center justify-between gap-4 md:w-184.5 lg:w-250">
            ...
            <nav id="navbar" class="fixed w-60 h-screen z-2 text-2xl top-0 right-0 bg-[#cbcfc3] dark:bg-[#0f172a] rounded-l-2xl transition-all duration-100 ease-in-out md:relative md:flex md:flex-1 md:items-center md:w-fit md:h-fit md:translate-x-0 dark:md:bg-[#00000000] md:bg-[#00000000] md:text-xl"
